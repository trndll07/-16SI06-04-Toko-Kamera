...
<ol class="breadcrumb">
  <li class="breadcrumb-item">
    <a href="<?php echo base_url(); ?>admin/cameras">Camera</a>
  </li>
  <li class="breadcrumb-item active">New Camera</li>
</ol>
      ...
      <div class="col-lg-12">
	    ...
	    <div class="card">
	      <div class="card-header">
	        <strong>Camera</strong> Form</div>
	      <div class="card-body">
			<?php echo form_open_multipart('admin/cameras/create'); ?>
